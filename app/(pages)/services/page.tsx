      ...
      >
        ...
        <div className="relative z-10 pt-24 pb-24 px-4 sm:px-6 md:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div 
              ref={containerRef}
              className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-5 lg:gap-6 mb-16"
            >
              {services.map((service, idx) => (
                <motion.button
                  ...
                  className="group relative h-56 sm:h-64 md:h-72 lg:h-80 text-left focus:outline-none focus:ring-2 focus:ring-white/50 rounded-2xl"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: idx * 0.05, duration: 0.5 }}
                  whileHover={{ y: -8 }}
                  type="button"
                  style={{ cursor: 'url("data:image/svg+xml;charset=utf8,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%2720%22 height=%2720%22 viewBox=%220 0 20 20%22%3E%3Ccircle cx=%2710%27 cy=%2710%27 r=%278%27 fill=%22white%22 opacity=%220.8%22/%3E%3Ccircle cx=%2710%27 cy=%2710%27 r=%275%27 fill=%22none%22 stroke=%22white%22 stroke-width=%221%22 opacity=%220.6%22/%3E%3C/svg%3E") 10 10, pointer' }}
                >
                  <motion.div
                  ...
                  <div className="relative w-full h-full p-3 sm:p-4 md:p-5 lg:p-6 rounded-2xl border border-white/20 bg-white/5 backdrop-filter backdrop-blur-xl transition-all duration-500 group-hover:border-white/50 group-hover:bg-white/10 group-hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] flex flex-col justify-between overflow-hidden">
                    ...
                    >
                      <img
                        ...
                        alt={service.name}
                        className="w-12 sm:w-14 md:w-16 h-12 sm:h-14 md:h-16 object-contain drop-shadow-lg filter brightness-0 invert"
                      />
                    </motion.div>

                    <div className="relative z-10">
                      <h3 className={`${righteous.className} text-base sm:text-lg md:text-xl font-bold text-white mb-1 group-hover:text-white/90 transition-colors line-clamp-2`}>
                        {service.name}
                      </h3>
                      
                      <motion.div
                        className="h-px bg-gradient-to-r from-white via-white to-transparent my-1.5 sm:my-2"
                        initial={{ scaleX: 0 }}
                        whileInView={{ scaleX: 1 }}
                        transition={{ duration: 0.6 }}
                      />
                      
                      <p className="text-white/50 text-xs sm:text-sm group-hover:text-white/70 transition-colors line-clamp-1">
                        {service.desc}
                      </p>
                    </div>

                    <motion.div
                      className={`absolute top-3 right-3 sm:top-4 sm:right-4 w-2.5 h-2.5 rounded-full border-2 border-white/40 transition-all z-20 ${
            ...
            {selectedServiceIndex === null && (
              ...
              >
                ...
                <Link href="/projects">
                  <motion.button
                    className="px-6 sm:px-8 py-3 md:px-10 md:py-4 rounded-full border border-white/30 bg-white/10 backdrop-blur-xl text-white text-sm sm:text-base md:text-lg font-semibold relative overflow-hidden group"
          ...
          {selectedService && (
            <>
              <motion.div
                ...
                exit={{ opacity: 0 }}
                onClick={closeModal}
                style={{ cursor: 'url("data:image/svg+xml;charset=utf8,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%2720%22 height=%2720%22 viewBox=%220 0 20 20%22%3E%3Cpath d=%22M10 2L15 8H5Z%22 fill=%22white%22 opacity=%220.8%22/%3E%3C/svg%3E") 10 10, pointer' }}
              />
